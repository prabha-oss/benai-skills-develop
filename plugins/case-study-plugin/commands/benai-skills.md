---
description: Create a case study presentation (PPTX). Guides you through extracting narrative from raw data, co-creates the story, and generates polished slides.
---
